        ...
        },
        {
            ...
            "structure_json": {
                ...
                "blocks": [
                    ...
                    _jd_block(phase="main_set", duration_min=65, instructions="Run steady at E effort, fuel and stay patient.", pace_zone="Z2", hr_zone="Z2", rpe_range=[3, 4], intensity_code="E"),
                    _jd_block(phase="main_set", duration_min=15, instructions="Finish strong at marathon pace/effort if readiness and mechanics are stable.", pace_zone="Race Pace", hr_zone="Z3-Z4", rpe_range=[5, 6], intensity_code="M"),
            ...
            "structure_json": {
                ...
                "blocks": [
                    ...
                    _jd_block(
                        phase="strides",
                        duration_min=4,
                        instructions="6 x 20s relaxed strides with full walk/jog recovery.",
                        pace_zone="Strides",
                        hr_zone="Z2-Z4",
                        rpe_range=[4, 6],
                        intensity_code="R",
                        extra={"repetitions": 6, "work_duration_sec": 20},
                    ),
                    _jd_block(phase="cooldown", duration_min=6, instructions="Easy shuffle cooldown.", pace_zone="Z1", hr_zone="Z1", rpe_range=[2, 3], intensity_code="E"),
                ],
            },
...
def _gold_standard_progressive_variants() -> list[dict[str, Any]]:
    ...
    for name, total, main_desc, main_code, pace_zone, hr_zone, rpe in [
        ...
        add_template(
            name=name,
            duration_min=total,
            intent=("threshold" if main_code == "T" else "marathon_pace" if main_code == "M" else "strides"),
